# Référence client - Scoring de leads marketing
...
## Périmètre réalisé
Construction d’un modèle de scoring règles + data pour prioriser les leads commerciaux. Restitution dans Power BI et documentation des critères de scoring.

## Technologies et compétences mobilisées
Python, SQL, Power BI, API CRM
