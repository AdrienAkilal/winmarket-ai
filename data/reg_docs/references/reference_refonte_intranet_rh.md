# Référence client - Refonte intranet RH
...
## Périmètre réalisé
Refonte UX et technique d’un intranet RH avec base documentaire, demandes internes et workflows simples. Projet mené en agile avec ateliers utilisateurs.

## Technologies et compétences mobilisées
Vue.js, Java, SSO, API RH
